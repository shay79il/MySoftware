properties([parameters([[$class: 'ChoiceParameter', choiceType: 'PT_SINGLE_SELECT', filterLength: 1, filterable: false, defaultValue: 'QA', name: 'ENV_NAME', randomName: 'choice-parameter-19800159933526', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: ''], script: [classpath: [], sandbox: false, script: 'return [\'PRODUCTION\',\'PREPRODUCTION\',\'QA\']']]], [$class: 'CascadeChoiceParameter', choiceType: 'PT_SINGLE_SELECT', filterLength: 1, filterable: false, defaultValue: 'us-east-1', name: 'REGION', randomName: 'choice-parameter-19800164539727', referencedParameters: 'ENV_NAME', script: [$class: 'GroovyScript', fallbackScript: [classpath: [], sandbox: false, script: 'return [\'Option error\']'], script: [classpath: [], sandbox: false, script: '''def choices
switch(ENV_NAME){
    case \'PRODUCTION\':
